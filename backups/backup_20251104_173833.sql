...
--
-- Current Database: `buku_tamu`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `buku_tamu` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
INSERT INTO `user` VALUES (18,'yudha','03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4','2025-11-01 21:14:46'),(19,'budi','e8979d2eb704c94fa2fa5044edba1c29232526eec3965ffc64308b6783f2de12','2025-11-01 21:18:10');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Current Database: `kopkar-tifico`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `kopkar-tifico` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
DROP TABLE IF EXISTS `ambil_tabungan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `ambil_tabungan` WRITE;
/*!40000 ALTER TABLE `ambil_tabungan` DISABLE KEYS */;
/*!40000 ALTER TABLE `ambil_tabungan` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Current Database: `monitoring_lab`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `monitoring_lab` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
INSERT INTO `db` VALUES ('%','test','','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','N','N','Y','Y','Y'),('%','test\\_%','','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','N','N','Y','Y','Y'),('localhost','phpmyadmin','pma','Y','Y','Y','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N');
...
INSERT INTO `global_priv` VALUES ('localhost','root','{\"access\":18446744073709551615}'),('127.0.0.1','root','{\"access\":18446744073709551615}'),('::1','root','{\"access\":18446744073709551615}'),('localhost','pma','{\"access\":0,\"plugin\":\"mysql_native_password\",\"authentication_string\":\"\",\"password_last_changed\":1571661132}');
